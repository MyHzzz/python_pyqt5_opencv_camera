...
class VideoBox(QWidget):
    ...
    def __init__(self, video_url="", video_type=VIDEO_TYPE_OFFLINE, auto_play=False):
        ...
        init_image = QPixmap("resource/camera.png").scaled(self.width(), self.height())
...
if __name__ == "__main__":
    ...
    mw = VideoBox()
    mw.set_video("rtmp://live.hkstv.hk.lxdns.com/live/hks", VideoBox.VIDEO_TYPE_OFFLINE, False)
    mw.show()
    sys.exit(mapp.exec_())
